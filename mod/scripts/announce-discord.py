...
NEXUS_FILES = "https://www.nexusmods.com/crimsondesert/mods/3488?tab=files"
GITHUB_RELEASE = "https://github.com/shin2344234/flight-freedom/releases/tag/v%s"
...
def version():
    ...
    return re.search(r'FP_VERSION\s+"([^"]+)"', header).group(1)
...
def post(token, channel, content):
    ...
    req = urllib.request.Request(url, data=json.dumps({"content": content}).encode("utf-8"),
                                 headers={"Content-Type": "application/json",
                                          ...
                                          "User-Agent": "FlightFreedom-announce"})
